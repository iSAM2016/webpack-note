    ...
    render() {
        ...
        const getcontent = function () {
            if (is_goto_lottery) {
                ...
                return (
                    <span>您还差{needcourse}节课可参与抽奖</span>
                )
            }
        }
        return (
        ...
        return (
            <div className="goodstudent">
                ...
                <div className="banner">
                    <div className="btnlist" onClick={() => { this.gotolist() }}></div>
                </div>
                {/* 中奖信息 */}
                {/* <Luckydog /> */}
                {/* 九宫格 */}
                <div className="nine">
                    <div className="nine-container">
                        <div className="nine-box">
                            ...
                            <RowBtn needcourse={needcourse} beigin={this.handleBegin} is_goto_lottery={is_goto_lottery} />
                ...
                {is_goto_lottery && <div className="classInfor"> 累计上课数{finish_class_num}节，可抽奖{lottery_number}次 </div>}
                {/*奖品列表*/}
                ...
                <div className="rule">
                    ...
                    <p>1. 在暑期期 间 ，当同学上课 课程累计满7节时，可获得《三好学生》抽奖机会一次； </p>
                    <p>2. 每人抽奖次数不限，<span className='highlight'>100%中奖</span>;</p>
                    <p>3. 奖品抽完为止。</p>
                    <p className="title">奖品领取说明</p>
                    <p>1. 获得课程奖励的同学请通过联系自己学管来进行兑奖</p>
                    < p > 2. 获得实物奖励的同 学 将于中奖后3- 7 个工作日以邮寄方式 寄出。</p>
                </div>
