...
module.exports = {
    ...
    dev: {
        isdev: true,
        port: 8001,
        root: 'suhailong@dev01.bj.lejent.cc',
        publicPath: './',
        assetsRoot: `/data/static/wb/${assetsSubDirectory}/`,
        baseurl: '//wb.lejent.cn',
    },
    uat: {
        isdev: false,
        root: 'work@inner57.bj.lejent.cc',
        publicPath: `web-development/wb/`,
        assetsRoot: `~/uat_static/wb/static/www/${assetsSubDirectory}/`,
        baseurl: '//static.afanti100.com/',
    },
    prod: {
        isdev: false,
        publicPath: 'web/wb/',
        assetsRoot: `~/afanti_online_8504/static/www/${assetsSubDirectory}/`,
        baseurl: '//static.afanti100.com',
        server: [
            {
                host: 'work@wb01.bj.lejent.cc',
                username: 'work@$wb01.bj.lejent.cc',
                password: 'wlcz1rH',
            },
            {
                host: 'work@wb02.bj.lejent.cc',
                username: 'work@$wb02.bj.lejent.cc',
                password: 'wlcz1rH',
            },
            {
                host: 'work@3.bj.lejent.cc',
                username: 'work@$3.bj.lejent.cc',
                password: 'wlcz1rH',
            }
        ]
    },
    ...
    oss: {
        ...
        accessKeyId: 'LTAIKZvZejrSX3O5',
        accessKeySecret: '9D9eI4QyXGPR4P46aaPwgSoKRL9ipY',
        useBucket: 'afanti-static'
    },
    // projectPath,
    osspath: '//static.aft1v1.com',// oss 路径'
    global,
